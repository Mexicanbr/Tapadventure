...
def print_welcome_message():
    print(r"""
 __  __           _                 _          ____            _       _
|  \/  | _____  _(_) ___ __ _ _ __ | |__  _ __/ ___|  ___ _ __(_)_ __ | |_
| |\/| |/ _ \ \/ / |/ __/ _` | '_ \| '_ \| '__\___ \ / __| '__| | '_ \| __|
| |  | |  __/>  <| | (_| (_| | | | | |_) | |   ___) | (__| |  | | |_) | |_
|_|  |_|\___/_/\_\_|\___\__,_|_| |_|_.__/|_|  |____/ \___|_|  |_| .__/ \__|
                                                                |_|
          """)
...
def load_credentials():
    try:
        ...
        print("File 'data.txt' not found. Make sure the file is in the same directory as the script...")
        return []
...
def main():
    ...
    while True:
        for index, authorization in enumerate(credentials):
            ...
            print(f"{Fore.CYAN+Style.BRIGHT}============== [ Acount {index+1} ] ==============")
            if info:
